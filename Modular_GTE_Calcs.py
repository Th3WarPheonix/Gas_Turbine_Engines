...
def engine_walkthrough(Tambient, Pambient, mach0, mach1, inlet_press_rec, fan_eff, fan_press_ratio, bypass_ratio, comp_eff, comp_press_ratio, m31, LHV, Tt4, comb_eff, comb_press_drop, core_turb_eff, fan_turb_eff, turbine_cool_flow, vel_coeff_core, vel_coeff_fan, thrust, gamma_hot, gamma=1.4, R_gas=287.05):
    ...
    return (station0, station1, station3, station4, station49, station495, station5, station9, station13, station19, stationSummary)
...
def engine_configurations(Tambient, Pambient, mach0, mach1, inlet_press_rec, fan_eff, fan_press_ratio, bypass_ratio, comp_eff, comp_press_ratio, m31, LHV, Tt4, comb_eff, comb_press_drop, core_turb_eff, fan_turb_eff, turbine_cool_flow, core_exh_coeff, fan_exh_coeff, thrust, gamma_hot):
    ...
    for i in range(len(comp_press_ratio)):
        stations  = engine_walkthrough(Tambient, Pambient, mach0, mach1, inlet_press_rec, fan_eff, fan_press_ratio, bypass_ratio[i], comp_eff, comp_press_ratio[i], m31, LHV, Tt4[i], comb_eff, comb_press_drop, core_turb_eff, fan_turb_eff, turbine_cool_flow, core_exh_coeff, fan_exh_coeff, thrust[i], gamma_hot)
...
def engine_config_plots(dfConfigs, comp_press_ratio, Tt3max, Tt495max, Fuel_Vol, max_diam):
    ...
    axs[0,0].scatter(comp_press_ratio[1:], dfConfigs.loc['3 Compressor Exit', 'Total Temperature Actual (R)'][1:] - 460, marker='.')
    ...
    print(convert_temps(dfConfigs.loc['4.95 LPT Entrance', 'Total Temperature (R)'][1:], 'SI')-273)
    axs[0,1].scatter(comp_press_ratio[1:], convert_temps(dfConfigs.loc['4.95 LPT Entrance', 'Total Temperature (R)'][1:], 'SI')-273, marker='.')
    ...
    axs[1,0].scatter(comp_press_ratio[1:], dfConfigs.loc['Summary', 'Fuel Burn (gal)'][1:], marker='.')
    ...
    axs[1,1].scatter(comp_press_ratio[1:], dfConfigs.loc['Summary', 'Inlet Diameter (in)'][1:], marker='.')
